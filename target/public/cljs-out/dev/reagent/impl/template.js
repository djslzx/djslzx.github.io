...
var G__12627 = o;
goog.object.set(G__12627,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12631 = o;
goog.object.set(G__12631,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12632__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__12633__i < G__12633__a.length) {G__12633__a[G__12633__i] = arguments[G__12633__i + 0]; ++G__12633__i;}
  args = new cljs.core.IndexedSeq(G__12633__a,0,null);
} 
return G__12632__delegate.call(this,args);};
...
return G__12632__delegate(args);
});
...
var G__12635 = props;
var G__12635__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12635,cljs.core.cst$kw$id,id):G__12635);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12635__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__12635__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12636 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12636,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12636;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12637){
var map__12638 = p__12637;
var map__12638__$1 = (((((!((map__12638 == null))))?(((((map__12638.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12638.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12638):map__12638);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12638__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__12640_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12640_SHARP_);
}));
} else {
return null;
}
...
var vec__12643 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12643,(2),null);
...
var temp__5739__auto___12647 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12647 == null)){
} else {
var key_12648 = temp__5739__auto___12647;
(jsprops.key = key_12648);
}
...
var temp__5739__auto___12649 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___12649 == null)){
} else {
var key_12650 = temp__5739__auto___12649;
(jsprops.key = key_12650);
}
...
var G__12651 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12651) : reagent.impl.template.as_element.call(null,G__12651));
} else {
var temp__5739__auto___12652 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___12652 == null)){
} else {
var key_12653 = temp__5739__auto___12652;
(jsprops.key = key_12653);
}
...
var G__12655 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__12655)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__12655)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12656){
var G__12657 = cljs.core.first(seq12656);
var seq12656__$1 = cljs.core.next(seq12656);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12657,seq12656__$1);
}));
...
break;
default:
var G__12663 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12663;
continue;
...
var ctx = ({});
var vec__12665 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(1),null);
...
var G__12668 = (cljs.core.count(argv) - first_child);
switch (G__12668) {
case (0):
...
break;
case (1):
var G__12669 = component;
var G__12670 = jsprops;
var G__12671 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__12669,G__12670,G__12671);
