...
if((i < len)){
var k = (ks[i]);
var G__12582 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__12583 = (i + (1));
m = G__12582;
i = G__12583;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__12584 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__12584);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12586 = c;
var G__12586__$1 = (((G__12586 == null))?null:G__12586.prototype);
if((G__12586__$1 == null)){
return null;
} else {
return G__12586__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12588 = c;
var G__12588__$1 = (((G__12588 == null))?null:G__12588.prototype);
if((G__12588__$1 == null)){
return null;
} else {
return G__12588__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__12592__delegate = function (args){
var G__12590 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12590) : reagent.impl.component.as_element.call(null,G__12590));
};
...
while (G__12593__i < G__12593__a.length) {G__12593__a[G__12593__i] = arguments[G__12593__i + 0]; ++G__12593__i;}
  args = new cljs.core.IndexedSeq(G__12593__a,0,null);
} 
return G__12592__delegate.call(this,args);};
...
return G__12592__delegate(args);
});
...
var G__12596 = c;
var G__12596__$1 = (((G__12596 == null))?null:G__12596.constructor);
if((G__12596__$1 == null)){
return null;
} else {
return G__12596__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__12597 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12598 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12598);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12597);
}});
...
var c = this;
var G__12602_12604 = goog.object.get(c,"cljsRatom");
if((G__12602_12604 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12602_12604);
}
...
var renders_12605 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_12606 = cljs.core.first(cljs.core.vals(renders_12605));
...
if((cljs.core.count(renders_12605) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12605))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12606)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12606], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12607 = o;
goog.object.set(G__12607,cljs.core.name(k),v);
