...
var o8319 = temp__5733__auto__;
var temp__5733__auto____$1 = (o8319["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o8320 = temp__5733__auto____$1;
return (o8320["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8241__auto__ = f;
return (o__8241__auto__["toString"]).call(o__8241__auto__);
} else {
return "";
}
}catch (e8321){var _ = e8321;
return "";
}});
...
try{var o__8241__auto___8323 = t;
(o__8241__auto___8323["cljs$lang$ctorPrWriter"]).call(o__8241__auto___8323,t,writer);
}catch (e8322){var __8324 = e8322;
}
...
var char_code = (function (){var o__8241__auto__ = (new String(char$));
return (o__8241__auto__["charCodeAt"]).call(o__8241__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8241__auto__ = String;
return (o__8241__auto__["fromCharCode"]).call(o__8241__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__8325 = num_code;
switch (G__8325) {
case (1):
return (185);
...
var o__8241__auto__ = String;
return (o__8241__auto__["fromCharCode"]).call(o__8241__auto__,superscript_code);
});
/**
...
}catch (e8327){var _e__8248__auto__ = e8327;
return false;
}})())){
...
var vec__8328 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__8328,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o8331 = temp__5733__auto__;
var temp__5733__auto____$1 = (o8331["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o8332 = temp__5733__auto____$1;
return (o8332["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__8335){
var vec__8336 = p__8335;
var ns_detector = cljs.core.nth.call(null,vec__8336,(0),null);
...
var G__8342 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__8343 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__8342;
remaining_tokens = G__8343;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq8333){
var G__8334 = cljs.core.first.call(null,seq8333);
var seq8333__$1 = cljs.core.next.call(null,seq8333);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8334,seq8333__$1);
}));
...
var vec__8347 = cljs.core.split_with.call(null,(function (p1__8346_SHARP_){
return cljs.core.not_EQ_.call(null,p1__8346_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__8347,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__8347,(1),null);
...
var vec__8353 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__8353,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__8353,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__8356 = cljs.core.rest.call(null,remaining_tokens);
var G__8357 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__8356;
name_tokens = G__8357;
continue;
} else {
...
var vec__8360 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__8360,(0),null);
var arity = cljs.core.nth.call(null,vec__8360,(1),null);
var vec__8363 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__8363,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__8363,(1),null);
var vec__8366 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__8366,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__8366,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__8366,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__8366,(3),null);
...
var vec__8372 = result;
var munged_ns = cljs.core.nth.call(null,vec__8372,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__8372,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__8372,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__8372,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__8372,(4),null);
var arity = cljs.core.nth.call(null,vec__8372,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__8376 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__8376,(0),null);
var args = cljs.core.nth.call(null,vec__8376,(1),null);
var vec__8379 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__8379,(0),null);
var name = cljs.core.nth.call(null,vec__8379,(1),null);
...
var G__8382 = (arity + (1));
var G__8383 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__8384){
var vec__8385 = p__8384;
var arity = cljs.core.nth.call(null,vec__8385,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__8385,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__8388_SHARP_){
return cljs.core.get.call(null,arities,p1__8388_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__8389_SHARP_){
return cljs.core.drop.call(null,(2),p1__8389_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___8396 = arguments.length;
var i__4737__auto___8397 = (0);
while(true){
if((i__4737__auto___8397 < len__4736__auto___8396)){
args__4742__auto__.push((arguments[i__4737__auto___8397]));

var G__8398 = (i__4737__auto___8397 + (1));
i__4737__auto___8397 = G__8398;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__8392){
var vec__8393 = p__8392;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__8393,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq8390){
var G__8391 = cljs.core.first.call(null,seq8390);
var seq8390__$1 = cljs.core.next.call(null,seq8390);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8391,seq8390__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__8402 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__8402,(0),null);
var fn_name = cljs.core.nth.call(null,vec__8402,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__8402,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__8402,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__8402,(4),null);
var arity = cljs.core.nth.call(null,vec__8402,(5),null);
...
var o__8241__auto__ = f;
return (o__8241__auto__["getBasis"]).call(o__8241__auto__);
});
/**
...
}catch (e8406){var _e__8248__auto__ = e8406;
...
var G__8407 = (obj[cljs.core.first.call(null,path)]);
var G__8408 = cljs.core.rest.call(null,path);
obj = G__8407;
path = G__8408;
continue;
} else {
...
var _STAR_ = (function (accum,p__8409){
var vec__8410 = p__8409;
var bit = cljs.core.nth.call(null,vec__8410,(0),null);
var protocol = cljs.core.nth.call(null,vec__8410,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__8413){
var vec__8414 = p__8413;
var ns = cljs.core.nth.call(null,vec__8414,(0),null);
var name = cljs.core.nth.call(null,vec__8414,(1),null);
var selector = cljs.core.nth.call(null,vec__8414,(2),null);
...
var post_process = (function (p__8418){
var vec__8419 = p__8418;
var munged_name = cljs.core.nth.call(null,vec__8419,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__8419,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__8417_SHARP_){
return (obj[cljs.core.first.call(null,p1__8417_SHARP_)]);
}),sorted_matches);
