...
var G__8893 = devtools.prefs.pref.call(null,v);
v = G__8893;
continue;
} else {
return v;
...
}catch (e8896){var _e__8248__auto__ = e8896;
return false;
}})();
...
}catch (e8900){var _e__8248__auto__ = e8900;
return false;
}})();
...
}catch (e8902){var _e__8248__auto__ = e8902;
return false;
}}
}
});
...
var vec__8904 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__8904,(0),null);
var name = cljs.core.nth.call(null,vec__8904,(1),null);
...
return cljs.core.some.call(null,(function (p1__8907_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__8907_SHARP_);
}),template);
});
